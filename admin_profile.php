			...
			<div class="donate_now_wrapper">
                <div class="food-form">
                    <form method="POST" action="php/functions.php">
                        ...
                        <input type="text" name="email" placeholder="Email" value="<?php echo UserDetails("email")?>" required>
                        <input type="text" name="name" value="<?php echo UserDetails("name")?>" placeholder="Name" required>
                    
                        <div class="col-lg-4">
							<div class="donate_box">
								<button type="submit" name="update_info" class="btn btn-danger w-100">Update Profile</button>
							</div>
						</div>
                    </form>
                </div>
