...
<header class="switcher-bar clearfix header text-center">
	...
	<section class="about_us section_gap">
        <h2 style="text-align:center;">Initial Approval</h2>
		<div class="container">
			<?php showNewChildren() ?>
		</div>

		<h2 style="text-align:center;">Second Approval</h2>
		<div class="container">
			<?php showSecChildren() ?>
		</div>

        <h2 style="text-align:center;">Fully Approval</h2>
		<div class="container">
			<?php showApprovedChildren() ?>
		</div>
	</section>
