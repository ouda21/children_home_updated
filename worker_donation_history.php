...
<header class="switcher-bar clearfix header">
	...
	<section class="about_us section_gap">
        <h2 style="text-align:center;">Food Donation History</h2>
		<div class="container">
			<?php foodDonationHistory() ?>
		</div>
	</section>
    <section class="about_us section_gap">
        <h2 style="text-align:center;">Money Donation History</h2>
		<div class="container">
			<?php moneyDonationHistory() ?>
		</div>
	</section>
