			...
			<div class="donate_now_wrapper">
                <div class="food-form">
                    <form method="POST" action="php/functions.php">
                        <input type="text" name="fname" placeholder="First Name" value="<?php echo UserDetails("first_name")?>" required>
                        <input type="text" name="lname" placeholder="Other Names" value="<?php echo UserDetails("last_name")?>" required>
                        <input type="text" name="username" value="<?php echo UserDetails("username")?>" placeholder="Username" required>
                        <input type="email" name="email" value="<?php echo UserDetails("email")?>" placeholder="Email... e.g ouda@" >
                        <input type="text" name="phone" placeholder="Phone" value="<?php echo UserDetails("phone")?>" Required>
                        <input type="text" name="location" placeholder="Location" value="<?php echo UserDetails("location")?>" required>
                        <div class="col-lg-4">
							<div class="donate_box">
								<button type="submit" name="update_info" class="btn btn-danger w-100">Complete Your Profile</button>
							</div>
						</div>
                    </form>
                </div>
