    ...
    <html lang="en">
        ...
        <header class="switcher-bar clearfix header">
			...
			<div class="donate_now_wrapper">
                <div class="food-form">
                    <form method="POST" action="php/worker_functions.php" >
                        <input type="text" class="form-group" name="start" value="<?php echo date("h:i:sa")?>" placeholder="Time In" required>
                        <div class="col-lg-4">
							<div class="donate_box">
								<button type="submit" name="time_in" class="btn btn-danger w-100">Submit</button>
							</div>
						</div>
                    </form>
                </div>
            ...
            <div class="donate_now_wrapper">
                <div class="food-form">
                    <form method="POST" action="php/worker_functions.php" >
                        <input type="text" name="end" class="form-group" value="<?php echo date("h:i:sa")?>" placeholder="Time Out" required>
                        <div class="col-lg-4">
							<div class="donate_box">
								<button type="submit" name="time_out" class="btn btn-danger w-100">Submit</button>
							</div>
						</div>
                    </form>
                </div>
