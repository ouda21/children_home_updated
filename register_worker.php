    ...
    <section class="make_donation section_gap">
		<div class="container">
			...
			<div class="donate_now_wrapper">
                <div class="food-form">
                    <form method="POST" action="php/admin_functions.php" enctype="multipart/form-data">
                        
                        <input type="text" name="fname" value="" placeholder="First Name" required>
                        <input type="text" name="lname" value="" placeholder="Last Name" required>
                        <input type="email" name="email" value="" placeholder="Email" required>
                        <input type="text" name="phone" value="" placeholder="Phone" required>
                        <input type="text" name="national_id" value="" placeholder="National id " required>
                        <input type="text" name="gender" value="" placeholder="Male or Female" required>
                        <div class="dropdown form-control">
                        <select name="rank" id="">
                            <option value="M">Manager</option>
                            <option value="A">Account</option>
                            <option value="G">Regular</option>
                        </select>
                        <br>
                        </div>
                        <div class="col-lg-4">
							<div class="donate_box">
								<button type="submit" name="register_worker" class="btn btn-danger w-100">Submit</button>
							</div>
						</div>
                    </form>
                </div>
