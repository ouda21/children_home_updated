    ...
    <section class="make_donation section_gap">
		<div class="container">
			...
			<div class="donate_now_wrapper">
                <div class="food-form">
                    <form method="POST" action="php/worker_functions.php">
                        ...
                        <input type="email" name="email" value="<?php echo UserDetails("email")?>" placeholder="Username" required>
                        <input type="phone" name="phone" value="<?php echo UserDetails("phone")?>" placeholder="Email... e.g ouda@" >
