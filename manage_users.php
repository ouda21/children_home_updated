...
<header class="switcher-bar clearfix header text-center">
                <nav class="navbar navbar-nav navbar-expand-lg navbar-dark bg-dark navigation">
                    ...
                    <ul class="navbar-nav nav-list">
                        ...
                        <li class="nav-item text-right"><a class="nav-link" href="contact.php">Manage Workser</a></li>
                        <li class="nav-item text-right"><a class="nav-link" href="donate.php">Donations</a></li>
						<li class="nav-item text-right"><a class="nav-link" href="user_profile.php"><?php echo $_SESSION["username"]?></a></li>
	...
	<section class="about_us section_gap">
		...
		<h2 style="text-align:center;">Suspended Users</h2>
		<div class="container">
			<?php showSuspendedUsers() ?>
		</div>
	</section>
